...
function App() {
  ...
  const countriesURL = "https://restcountries.eu/rest/v2/all?fields=name;flag;population;region;capital;subregion;nativeName;topLevelDomain;currencies;languages;borders";
